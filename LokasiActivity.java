...
public class LokasiActivity extends Service implements LocationListener
{
    ...
    public LokasiActivity(Context context)
    {
        _context = context;
        //getLocation();
    }
    ...
    {
        if (locManager != null)
            locManager.removeUpdates(LokasiActivity.this);
    }
}
